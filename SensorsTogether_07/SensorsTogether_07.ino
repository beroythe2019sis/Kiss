...
void setup() {
  ...
  Serial.begin(115200); // Starts the serial communication option: 115200, 9600
...
*/
  ...
  //Serial.print(" 3) Mic Max: ");
  Serial.print(", ");
  Serial.print (signalMax);
  //Serial.print(" 4) Mic Min: ");
  Serial.print(", ");
  ...
  //Serial.print(" 6) DHT Temp: ");
  Serial.print(", ");
  Serial.print((int)temperature); 

  //Serial.print(" 7) DHT Humid: "); 
  Serial.print(", "); 
  ...
  //Serial.print(" 8) Object: ");
  Serial.print(", "); 
  Serial.print(PIRstate); 


  // rain
  //Serial.print(" 9) rainsensor volts: ");
  Serial.print(", "); 
  Serial.print(rain); 

  // light
  //Serial.print(" 10) lightsensor volts: ");
  Serial.print(", "); 
